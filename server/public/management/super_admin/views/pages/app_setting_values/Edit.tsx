...
const Edit: React.FC<Props> = () => {
  ...
  function get_value(key: string): string | string[] {
    try {
  ...
  // Check if the title is 'Home Gallary' or 'Event Gallary'
                  ...
                  <div key={field} className="form-group form-vertical">
                    {state.item.type === 'file' && field === 'value' ? (
                      <InputImage
                        ...
                        multiple={isGallery} // Enable multiple uploads for galleries
                      />
                    ) : (
