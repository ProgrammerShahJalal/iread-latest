...
const ContactPage = () => {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    if (form.current) {
      emailjs
        .sendForm(
          process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID as string, // Replace with your Service ID
          process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID as string, // Replace with your Template ID
          form.current,
          process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY as string // Replace with your User ID
        )
        .then(
          (result) => {
  ...
  return (
    <div className="my-12 container">
      <h1 className="text-4xl text-center font-bold text-[#202C45] mb-8">Contact Us</h1>
