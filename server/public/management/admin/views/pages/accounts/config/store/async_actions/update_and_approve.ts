...
const fetch_api = async (param, thunkAPI) => {
    ...
    const response = await axios.post(
        `${end_point}/${api_prefix}/update-and-approve`,
        param,
    );
...
export const update_and_approve = createAsyncThunk<ReturnType, PayloadType, ThunkArgument>(
    `${store_prefix}/update-and-approve`,
    fetch_api,
);
